...
class _HomeScreenState extends State<HomeScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Pilih jenis struk untuk file ini:',
  ...
  Future<void> _processImage(String type, {String? imagePath}) async {
    ...
    try {
      ...
      final mimeType = (isRealPdf || isPdfExt)
          ? 'application/pdf'
          : 'image/jpeg';
      ...
      String displayName = type == 'Transfer'
          ? (result['nama_penerima'] ?? 'Transaksi')
          : (result['nama'] ?? 'Transaksi');
      ...
      if (nominal is int) {
        ...
        parsedNominal =
            int.tryParse(nominal.replaceAll(RegExp(r'[^0-9]'), '')) ?? 0;
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    _processImage('Transfer');
                  },
                ),
                ListTile(
                  leading: CircleAvatar(
                    backgroundColor: Colors.orange.shade100,
                    child: Icon(Icons.bolt, color: Colors.orange.shade800),
                  ),
                  title: const Text(
                    'Token Listrik',
                    style: TextStyle(fontWeight: FontWeight.w600),
                              ...
                              return InkWell(
                                onTap: () {
                                  if (item['data'] != null) {
                                    ...
                                    showCustomSnackBar(
                                      context,
                                      'Data riwayat ini tidak lengkap (versi lama).',
                                      isError: true,
                                    );
                                  }
                                },
    ...
    try {
      ...
      if (mounted) {
        ...
        if (errorMsg.contains("read failed") ||
          ...
          errorMsg =
              "Gagal terhubung! Pastikan printer menyala dan sudah di-Pairing. Hapus (Unpair) lalu sandingkan ulang jika masih gagal.";
        } else {
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            TextField(
              controller: bankCtrl,
              decoration: const InputDecoration(labelText: 'Bank (misal: BCA)'),
            ),
            TextField(
              controller: rekCtrl,
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Mencari ulang printer...'),
                                ),
                              );
                            },
                          ),
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      if (tempCtrl.text.isNotEmpty)
                                        _apiKeyCtrl.text = tempCtrl.text;
                                    });
                                    Navigator.pop(context);
                                  },
                                  child: const Text('Simpan'),
